...
Based on the version in CosmoloPy.
...
doc += "  c_km_s: Speed of light in km/s. \n"
...
#6.673e-8 cm^3 g^-1 s^-2
doc += "  G_const_Mpc_Msun_km_s: Gravitational constant in Mpc km^2 msun^-1 s^-2\n"
G_const_Mpc_Msun_km_s = M_sun_g * (6.673e-8) / (Mpc_cm * 1.e10) # Mpc km^2 msun^-1 s^-2 
